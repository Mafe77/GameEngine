...
namespace GameEngine
{
	...
	namespace Utils
	{
		...
		static GLenum EngineFBTextureFormatToGL(FramebufferTextureFormat format)
		{
			...
			GE_CORE_ASSERT(false, "EngineFBTextureFormatToGL");
			return 0;
		}
	...
	void OpenGLFramebuffer::Invalidate()
	{
		...
		{
			GE_CORE_ASSERT(m_ColorAttachments.size() <= 4, "ColorAttachment size greater than 4");
	...
	{
		GE_CORE_ASSERT(attachmentIndex < m_ColorAttachments.size(), "attach index less than color attach.");
	...
	{
		GE_CORE_ASSERT(attachmentIndex < m_ColorAttachments.size(), "ClearAttachment");
